...
foreach($timetable_info as $info){
  if($info[0] == $id_match){
    if($home_goal > $away_goal){
      ...
      $win_number_home++;
      $lose_number_away++;
      $your_goal_home = $your_goal_home + $home_goal;
      $opponent_goal_home = $opponent_goal_home + $away_goal;
      $your_goal_away = $your_goal_away + $away_goal;
      $opponent_goal_away = $opponent_goal_away + $home_goal;

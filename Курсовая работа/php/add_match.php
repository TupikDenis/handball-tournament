 ...
 <html lang="ru">
   ...
   <body background="../pictures/THW_RNL_Totale_f80f9_f_1920x1080.jpg">
     ...
     <div class="result" align="center">
       <table>
         <tr>
           <th width="400">Хозяева</th>
           <th>Счёт</th>
           <th>Счёт</th>
           <th width="400">Гости</th>
         </tr>
         <form class="" action="add_match_prosess.php" method="post">
         ...
         <tr>
           <td><?=$home_team?></td>
           <td><input type="number" value="0" name="home_goal" class="home_away"></td>
           <td><input type="number" value="0" name="away_goal" class="home_away"></td>
           <td><?=$away_team?></td>
         </tr>
       </table> <br>
          <input type="submit" name="button" class="button" value="Добавить">
        </form>
     </div>
   </body>
 </html>

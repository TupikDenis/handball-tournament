<?php
  ...
  $tournament_inform = mysqli_query($connect_user, "SELECT * FROM `tournament` WHERE `user_id` = '$id' ORDER BY `tournament_name`");
  ...
  <body background="../pictures/THW_RNL_Totale_f80f9_f_1920x1080.jpg">
    <div class="information">
      ...
      <div class="tournament_info" align="center">
        <h1>Список турниров, отсортированных в алфавитном порядке"</h1>
        <table>
          <tr>
